<!-- resources/views/owners.blade.php -->
{{-- 試しに作ってみた本の管理画面 --}}
<x-app-layout>
    ...
    {{-- <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <form action="{{ route('owner_index') }}" method="GET" class="w-full max-w-lg">
    ...
    <div class="flex bg-gray-100">
        ...
        <div class="text-gray-700 text-left px-4 py-4 m-2">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-500 font-bold">本を管理する</div>
            </div>

            <!-- 本のタイトル -->
            <form action="{{ url('owners') }}" method="POST" class="w-full max-w-lg">
                @csrf
                ...
                <div class="flex flex-col">
                    <div class="text-gray-700 text-center px-4 py-2 m-2">
                        <x-button class="bg-blue-500 rounded-lg">登録</x-button>
                    </div>
                </div>
            </form>
        </div>
